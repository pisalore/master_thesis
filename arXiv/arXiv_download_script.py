    ...
    while num_downloaded_files <= max_items:
        ...
        try:
            ...
            urllib.request.urlretrieve(
                pdf_download_url + file_identifier, downloaded_pdf_file_path
            )
            ...
            if num_errors == 3:
                print(
                    num_errors,
                    " encountered trying to fullfill the last request; exit.",
                )
                exit(-1)
            ...
            print(
                "PDF or Source files for "
                + file_identifier
                + " not found. Download the next file.\n"
            )
